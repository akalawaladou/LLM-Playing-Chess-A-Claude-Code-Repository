...
class OthelloGPT(nn.Module):
    """
    Small GPT trained to predict the next Othello move.

    Vocabulary: 64 tokens (one per board square) + 1 padding token.
    """
    ...
    def __init__(
        ...
        d_model: int = 128,
        n_heads: int = 4,
        max_len: int = 64,      # max game length in Othello ~ 60
...
if __name__ == "__main__":
    ...
    print(f"OthelloGPT: {n_params:,} parameters")
